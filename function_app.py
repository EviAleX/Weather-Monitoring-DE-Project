...
def weatherapifunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "weather-streaming-ws.servicebus.windows.net"
    ...
    def fetch_weather_data():
        ...
        VAULT_URL = "https://kv-weather-streaming-3.vault.azure.net/"
        ...
        # Sending the weather data to th Event HUB
